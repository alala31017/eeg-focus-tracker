...
**Live demo:** [https://muse-eeg-focus-tracker.streamlit.app/](#) 
...
### K-Fold vs. Leave-One-Session-Out (LOSO)
...
To simulate the real deployment scenario where models receive an unseen session data, models were re-evaluated with **Leave-One-Session-Out (LOSO) CV**, holding out one full recording session at a time:
